from flask import Flask, render_template, send_from_directory, redirect, url_for, request, flash,Blueprint,current_app
...
def save_picture(form_picture):
    ...
    picture_path = os.path.join(
        current_app.root_path, 'static/img', form_picture.filename)
